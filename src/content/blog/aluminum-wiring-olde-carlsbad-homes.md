...
faqs:
  - question: "Is aluminum wiring dangerous in Olde Carlsbad homes?"
    answer: "Aluminum branch wiring is not inherently dangerous, but connections at outlets and switches can loosen and oxidize over time, creating heat and arcing hazards. The wiring itself is not the problem — the termination points are."
  - question: "What is the correct fix for aluminum wiring in a Carlsbad home?"
    answer: "The two code-accepted remediation methods are COPALUM crimp connectors installed by a certified electrician, and AlumiConn connectors at each outlet and switch. Both methods create a proper copper-to-aluminum connection that eliminates the termination hazard."
  - question: "Does aluminum wiring need to be completely replaced?"
    answer: "In most cases, no. Complete rewiring is expensive and disruptive. For homes where the wiring is otherwise in good condition, COPALUM or AlumiConn remediation at all devices is the correct and code-accepted approach."
  - question: "How do I know if my Olde Carlsbad home has aluminum wiring?"
    answer: "Homes built between roughly 1965 and 1973 are most likely to have aluminum branch wiring. You can check by looking at the wire insulation in your panel or junction boxes — aluminum wire is silver-colored and the insulation is typically marked AL or aluminum."
  - question: "Can I get an EV charger if my home has aluminum wiring?"
    answer: "Yes. EV charger circuits use larger gauge wire that is often copper even in homes with aluminum branch wiring. We evaluate the panel and existing wiring during the assessment and identify the right installation path."
draft: false
---
...
For more on the electrical services we provide throughout Olde Carlsbad, see our [Olde Carlsbad electrician service area page](/olde-carlsbad/). For panel-specific work in this neighborhood, see our [electrical panel upgrades in Olde Carlsbad](/olde-carlsbad/electrical-panel-upgrades/) page.
