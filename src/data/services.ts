...
const baseServicePillars: ServicePillar[] = [
  ...
  // 8. Outlet, Switch, Dimmer & GFCI Repairs
  {
    ...
    seoTitleName: 'Outlet & GFCI Repair',
    publish: true,
    tier: 'wave1',
  ...
  // 10. Remodel & Rewiring (incl. ADU)
  {
    ...
    seoTitleName: 'Remodel & ADU Rewiring',
    publish: true,
    tier: 'wave2',
  ...
  // 11. Commercial Tenant Improvement (TI)
  {
    ...
    seoTitleName: 'Commercial TI Electrician',
    publish: true,
    tier: 'wave2',
  ...
  // 16. Restaurant & Food Service Electrical
  {
    ...
    seoTitleName: 'Restaurant Electrician',
    publish: true,
    tier: 'wave2',
  ...
  // 17. Commercial LED Lighting Retrofit
  {
    ...
    seoTitleName: 'Commercial LED Lighting',
    publish: true,
    tier: 'wave2',
